...
//       value: "crowd",
//       children: [
//         { name: "学生", value: "stutent" },
//         { name: "老师", value: "teacher" },
//         { name: "家长", value: "parents" },
//       ],
//     },
//     {
//       name: "适合年级",
...
//       value: "target",
//       children: [
//         { name: "识记", value: "memorization" },
//         { name: "理解", value: "understand" },
//         { name: "应用", value: "application" },
//         { name: "分析", value: "analysis" },
//         { name: "评价", value: "evaluation" },
//         { name: "创造", value: "create" },
//       ],
//     },
//     {
//       name: "分类类型",
//       value: "class",
//       children: [
//         { name: "学习工具", value: "tool" },
//         { name: "学习平台", value: "platform" },
//         { name: "作业题库", value: "work" },
//         { name: "知识社区", value: "community" },
//         { name: "语言学习", value: "learn" },
//         { name: "游戏化学习", value: "game" },
//       ],
//     },
//   ],
// });
...
// // 模拟博客列表
// Mock.mock(/^\/api\/applist(\?.+)?$/, "get", function (options) {
